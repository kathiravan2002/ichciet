...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'info.ichciet@gmail.com';
    $mail->Password   = 'pdtw oqfh gydl drvt'; // App Password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    // Email setup to admin
    $mail->setFrom('info.ichciet@gmail.com', 'ICHCIET Enquiry');
    $mail->addAddress('info.ichciet@gmail.com', 'ICHCIET Enquiry');
    ...
    $replyMail->Username   = 'info.ichciet@gmail.com';
    $replyMail->Password   = 'pdtw oqfh gydl drvt';
    $replyMail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $replyMail->Port       = 587;

    $replyMail->setFrom('info.ichciet@gmail.com', 'ICHCIET Team');
    $replyMail->addAddress($_POST['email'], $_POST['firstname'] . ' ' . $_POST['secondname']);
    $replyMail->isHTML(true);
    $replyMail->Subject = 'Thank you for your enquiry - ICHCIET 2025';
    ...
    $replyMail->Body = '
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            ...
            <p>Warm regards,<br>ICHCIET 2025 Team</p>
        </div>
    ';
