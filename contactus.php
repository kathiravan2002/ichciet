...
try {
    ...
    $mail->Password   = 'jjrs gpwa apzj bdgi'; // App password, not Gmail login
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    // Email setup
    $mail->setFrom('kathir.tcz@gmail.com', 'ICHCIET Enquiry');
    $mail->addAddress('kathir.tcz@gmail.com', 'ICHCIET Enquiry');
