...
function Datesandbank() {
    ...
    const dates = [
        ...
        {
            content1: "September 5, 2025",
            title: "Full Paper Submission Deadline",
            icon: "📄"
        },
        {
            content1: "September 12, 2025",
            title: "Notification of Acceptance",
            icon: "✅"
        },
        {
            content1: "September 24, 2025",
            title: "Final Paper Submission",
            icon: "📋"
        },
        {
            content1: "September 29, 2025",
            title: "Conference Dates",
            icon: "🎤"
        },
    ];
            ...
            <div className="lg:h-90 h-70   relative bg-cover bg-center " style={{ backgroundImage: "url('/images/allhero1.jpg')" }}>
                ...
                <div className="relative z-10 flex flex-col justify-center items-center h-full space-y-2">
                    ...
                    <div className="flex space-x-2 ">
                        ...
                        <h2 className="md:text-[24px] text-[20px] namdhinggo-medium  text-[#2AA11F] "><span className="text-white">/ </span>Important Dates</h2>
                    </div>
                </div>
            </div>
            <div >
                <h2 className="px-4 2xl:text-[32px] xl:text-[28px] lg:text-[28px] text-[28px] namdhinggo-extrabold text-[#2AA11F] text-center lg:mt-15 mt-10">Important Dates</h2>
            </div>
