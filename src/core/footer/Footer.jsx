...
const Footer = () => {
  return (
    <footer className="bg-[#2AA11F] text-white rounded-tl-xl rounded-tr-xl">
      ...
      <div className='grid lg:grid-cols-3 grid-cols-1  items-center    py-3 '>
        ...
        <div className="text-center md:text-base text-xs inter-regular">
          <p>© 2025 <span className='hover:underline' > <Link to="/" target='_blank'>ICHCIET </Link> </span> . All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
